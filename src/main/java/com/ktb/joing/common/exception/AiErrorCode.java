...
public enum AiErrorCode implements ErrorCode {
    ...
    AI_INVALID_CHANNEL_ID(HttpStatus.UNPROCESSABLE_ENTITY, "유효하지 않은 형식의 채널아이디입니다."),
    AI_NOT_ENOUGH_UPLOADS(HttpStatus.UNPROCESSABLE_ENTITY, "영상의 개수가 충분하지 않아 더이상의 평가가 불가능합니다.");
