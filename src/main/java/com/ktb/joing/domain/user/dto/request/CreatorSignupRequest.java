...
public class CreatorSignupRequest {
    ...
    @Builder
    public CreatorSignupRequest(String nickname, String email, String channelId, String channelUrl, Long subscribers, String profileImage, MediaType mediaType, Category category) {
